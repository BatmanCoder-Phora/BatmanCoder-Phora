...
namespace DevelopmentTests
{
    ...
    public class DependencyGraphTest
    {
        ...
        /// <summary>
        ///Empty graph should contain one
        ///</summary>
        [TestMethod()]
        ...
        public void SimpleThisTest()
        {
            ...
            t.AddDependency("c", "x");
            t.AddDependency("d", "x");
            Assert.AreEqual(4, t["x"]);
        }
        /// <summary>
        /// test the this method when s does not exsist.
        /// </summary>
        [TestMethod()]
        public void SimpleThisTestZERO()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("a", "x");
            t.AddDependency("b", "x");
        ...
        ///</summary>
        [TestMethod()]
        public void SimpleSizeRemoveTest()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("x", "y");
            t.AddDependency("x", "f");
        ...
        ///</summary>
        [TestMethod()]
        public void HasDepdentsTestFalse()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("a", "b");
            t.AddDependency("a", "c");
        ...
        ///</summary>
        [TestMethod()]
        public void HasDepdeesTestFalse()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("a", "b");
            t.AddDependency("a", "c");
        ...
        /// <summary>
        /// test my adding and removing Dependency methods. 
        /// </summary>
        [TestMethod()]
        public void MyAddingAndRemovingStressTest()
        {
            DependencyGraph t = new DependencyGraph();
            t.AddDependency("a", "b");
            t.AddDependency("a", "c");
            ...
            t.RemoveDependency("c", "j");
            t.RemoveDependency("c", "l");
            t.RemoveDependency("c", "r");
            t.RemoveDependency("c", "t");
