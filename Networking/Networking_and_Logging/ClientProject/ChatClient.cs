...
namespace CS3500
{
    ...
    public class ChatClient
    {
        ...
        public ChatClient(ILogger logger, int portNum)
        {
            Logger = logger;
            port = portNum;
        }
        ...
        public static void Main(string[] args)
        {
            ...
            using (ServiceProvider serviceProvider = services.BuildServiceProvider())
            {
                ...
                client = new ChatClient(logger);
                logger.LogInformation("A client has been created. \n");
                //Thread.Sleep(1000);
                //provider.Dispose();
            }
            ...
            Console.Read();
            client.Logger.LogInformation("A client has disconnected form the server. \n");
            Thread.Sleep(1000);
        }
        ...
        public void ConnectToServer(string serverAddr)
        {
            ...
            {
                Logger.LogError("A client was unable to connect to the server. \n");
            }
        ...
        {     
            ...
            Logger.LogInformation("A client was able to connect to the server. \n");
            ...
            {
                Logger.LogError($"Something happened with the endConnect and caused error: {e}\n");
            }
            ...
            {
                Logger.LogError($"The client has errored {e} and has not received. \n");
            }
        }
        ...
        private void OnReceive(IAsyncResult ar)
        {
            ...
            Logger.LogInformation($"A message of {message} was received. \n");
